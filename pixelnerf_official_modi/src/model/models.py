...
class PixelNeRFNet(torch.nn.Module):
    ...
    def encode(self, images, poses, focal, z_bounds=None, c=None):
        ...
        ############ feature extract #############
        self.encoder(images) # latent torch.Size([1, 512, 150, 200]) 1장의 이미지(200*300) 넣어 512 ch. 150*200 size feature 뽑음
        ...
        with profiler.record_function("model_inference"):
            ...
            if self.d_in > 0:
                ...
                if self.use_viewdirs:                  
                    ...
                    # viewdirs = self.code(viewdirs) # torch.Size([14400, 39])

                    z_feature = torch.cat((z_feature, viewdirs), dim=1)  # (SB*B, )
            ...
            # z_feature: torch.Size([192, 42]) # [64,42] [64,42] [64,42] 세 pixel에 해당하는 값으로 나누어짐
            ...
            if self.use_encoder:
                ...
                # uv's feature value == latent: 1 view torch.Size([1, 512, 4800]) 3 view torch.Size([3, 512, 4800])
                ...
                # latent: torch.Size([4800, 512]) 3 view torch.Size([3*4800, 512]) 
